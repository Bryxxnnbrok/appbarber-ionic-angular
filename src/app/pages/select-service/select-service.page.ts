...
import { IonHeader, IonToolbar, IonTitle, IonButtons, IonMenuButton, IonBackButton, IonContent, IonButton } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, IonHeader, IonToolbar, IonTitle, IonButtons, IonMenuButton, IonBackButton, IonContent, IonButton],
